...
\begin{filecontents*}[overwrite]{\jobname.xmpdata}
  ...
  The DQN algorithm is given in Algorithm~\ref{alg:dqn}. As deep RL methods are rarely trained with plain SGD, instead opting for adaptive methods like Adam \cite{kingma2015adam}, the pseudocode in this section abstracts away the choice of optimizer.
