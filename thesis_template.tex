...
shows that with small batch size in Name This Game, the accepted step sizes are roughly 3 orders of magnitude larger than the tuned baseline and performance flatlines, a pattern that holds in the other environments as well \todo{for Adam: do i need to show this in appendix or ok just saying?}. Note that 
\begin{figure}[htbp]
    \centering
