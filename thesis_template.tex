...
Adam hyperparameters are set according to the Optax library defaults \tocite{optax}, open AI baselines \tocite{37 details, open ai baselines}, and Dopamine \tocite{dopamine} in classic control, Brax, and the Atari-5, respectively. Settings for Adam are reported alongside algorithm hyperparameters in Appendix~\ref{app_hyperparams}. % todo: add entries to the hyper table for adam beta1, beta2, epsilon and i will fill them in
...
\begin{figure}[htbp]
    ...
    \caption{Effect of batch size on DQN with Adam on Atari-5.}
