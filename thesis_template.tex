...
\begin{filecontents*}[overwrite]{\jobname.xmpdata}
  \Title{Beyond Fixed Learning Rates: Stochastic Line Search and Trust Region in Deep Reinforcement Learning}
...
\begin{titlepage}
  \centering
  \textbf{\large{Beyond Fixed Learning Rates: Stochastic Line Search and Trust Region in Deep Reinforcement Learning}}
...
% Dont remove until you add one of your own citations.
Start introduction from here \cite{sorg2010linear}.
