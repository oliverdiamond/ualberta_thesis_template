...
\begin{figure}[htbp]
    ...
    \textbf{(a) Left:} Contours of a quadratic $f$ with
    $\nabla^2 f = \mathrm{diag}(10,1)$, whose curvature is largest along $x_1$. 
    \textbf{(b) Right:} The same function in the transformed coordinates $y = A^{1/2}x$ with
