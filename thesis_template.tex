...
\begin{algorithm}[h] % todo: make consistent with terminology and notation and formatting used in sec:adaptive
...
\section{First-Order Trust Region}
\todo{This is the new method that is very similar to mine I think is important to compare to, very simple first order TR}

\section{Gain-Ratio Adaptive Step Size} % TODO: make terms and style consistent and formatting consistent with the other pseudocode
\begin{algorithm}
...
\subsection{Globalization Strategies with Momentum-Based Optimizers}

\subsection{Globalization Strategies with Sharpness Aware Minimization}
