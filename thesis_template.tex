...
Having defined the deep RL algorithms that , we now turn to line search methods, the first of the two globalization strategies for adaptive step size examined in this work. 
